...
- A chave Qdrant é exclusiva por ambiente e possui procedimento de geração, distribuição, rotação e revogação.
...
- O runbook de rotação é executado antes da v0.1 e registra apenas identificador/data, nunca a chave.
