...
source: excalibull/targets/etoro/arapuca.md
collected_at: 2026-09-08T16:41:49Z
tags: [excalibull, import, chains, idor, bola]
asset_refs: [etoro.com, www.etoro.com, public-api.etoro.com, mcp.public-api.etoro.com, agent.public-api.etoro.com, por.etoro.com, affapi.etoro.com, cashier.etoro.com, kyc.etoro.com, goodwallet.etoro.com, oauth.wallet.etoro.com]
---
...
- **Conta:** real, não-demo, `<REDIGIDO:email-conta-teste>` (user `moldretvalor7284`, `gcid 49462268`). Onboarding travado em **verificação de telefone** — endpoint rate-limited (Cloudflare 1015, ~23h). Sem isso: sem KYC, sem API key formal, `Credit: 0`.
