...
class AdministrationTests(unittest.TestCase):
    ...
    def test_health_uses_authenticated_collection_listing(self):
        client = FakeQdrant()
        self.assertEqual(admin.health(client), {"healthy": True})
        self.assertEqual(client.calls, [("GET", "/collections", None)])
