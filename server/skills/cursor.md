# Cursor AI Agent Skill - Qdrant RAG MCP Server Integration

This repository is integrated with the **Go Qdrant-RAG MCP Server** which indexes the workspace in real-time into a Qdrant vector database using Ollama embeddings. As the Cursor AI Agent, you have direct access to semantic search capabilities across this entire repository.
