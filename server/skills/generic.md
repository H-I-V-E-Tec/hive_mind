# Qdrant RAG MCP Server Integration Instructions

This workspace is integrated with a **Go Qdrant-RAG MCP Server** which monitors all files in real-time and auto-indexes changes into a Qdrant vector database using Ollama embeddings. As the AI assistant, you should use the semantic vector search capabilities of this server to answer user questions, lookup code context, and maintain stylistic consistency.
